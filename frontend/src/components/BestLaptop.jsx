import banner from "../assets/laptopBanner.png";
import sm from "../assets/sm-m.png"
...
const BestLaptop = () => {
    ...
    const arr2 = finalProducts.filter((item) => item.category === "laptops").slice(0, 5);

    return (
        <>
            <section className="bg-gray-100 p-4 md:p-8 rounded-xl max-w-7xl mx-auto mt-5">
                <div className="flex justify-between items-center">
                    <h2 className="font-semibold uppercase">Top Laptops</h2>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-4 mb-8">
                    <div className="col-span-2 bg-gradient-to-r from-gray-300
                     to-gray-200 rounded-xl p-6 flex flex-col justify-center bg-banner bg-cover bg-center bg-no-repeat h-50 "
                        ...
                        <h3 className="text-base md:text-2xl font-semibold mb-2 text-white">
                            <span>Mobok 2</span> br superchard</h3>
                        <p className="text-sm text-white mb-4">Rise to the challenge</p>
