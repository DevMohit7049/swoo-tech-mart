...
const Navbar = () => {
    ...
    const navLinks = [
        { to: ROUTE_PATHS.ROOT, label: "Home", icon: <FaHome /> },
        { to: ROUTE_PATHS.SHOP, label: "Products", icon: <FaBoxOpen /> },
        { to: ROUTE_PATHS.CONTACT, label: "Contact", icon: <FaEnvelope /> },
    ];
        ...
        <>
            ...
            >
                ...
                <div className="flex items-center justify-between px-4 py-4 border-b border-gray-100">
                    <Link to={ROUTE_PATHS.ROOT} onClick={closeMenu}>
                        <img src={MainContent.appLogo} className="h-9 w-auto object-contain" alt={MainContent.appName} />
                    </Link>
                    <button
                        onClick={closeMenu}
                ...
                >
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="flex justify-between items-center h-20">
                            ...
                            {/* Logo */}
                            <Link to={ROUTE_PATHS.ROOT} className="text-2xl font-bold text-blue-600">
                                <img src={MainContent.appLogo} className="h-10 w-auto object-contain" alt={MainContent.appName} />
                            </Link>
                            ...
                            <div className="hidden lg:flex items-center gap-5">
                                ...
                                {user && (
                                    <Link to={ROUTE_PATHS.ADMIN_DASHBOARD} className="text-gray-700 font-semibold text-sm">
                                        Welcome, {user.name}
                                    </Link>
                                )}
                                {user ? (
                                    ...
                                    <div className="text-right leading-tight">
                                        ...
                                        <div className="flex items-center gap-1">
                                            <Link to={ROUTE_PATHS.LOGIN} className="text-[15px] font-semibold uppercase text-gray-800 hover:text-brand-primary transition-all">
                                                Log in
                                            </Link>
                                            <span className="text-gray-300">/</span>
                                            <Link to={ROUTE_PATHS.REGISTER} className="text-[15px] font-semibold uppercase text-gray-800 hover:text-brand-primary transition-all">
                                                Register
                                            </Link>
                                        </div>
                                    </div>
                                )}
                                <Link to={ROUTE_PATHS.CART} className="relative border-l border-gray-200 pl-4">
                            ...
                            <div className="flex lg:hidden items-center gap-3">
                                <Link to={ROUTE_PATHS.CART} className="relative">
