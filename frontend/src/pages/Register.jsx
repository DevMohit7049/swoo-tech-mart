...
const Register = () => {
    ...
    // need to fix register user auto login
            ...
            <div className="w-full max-w-5xl bg-[#f3f3f3] border border-[#d9d9d9] rounded-md p-6 md:p-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10 items-center">
                    ...
                    <div className="w-full max-w-[420px]">
                        <h2 className="text-[38px] leading-none font-extrabold text-[#1fba36]">Create Account</h2>
                        ...
                        <p className="text-[12px] mt-5 text-[#a4a4a4] uppercase">
                            Already user ?{' '}
                            <Link to="/login" className="text-[#1fba36] hover:underline font-semibold">
                                Login
                            </Link>
                        </p>
                    </div>
