...
const AddProductForm = ({ selectedProduct, setSelectedProduct }) => {
   ...
   const onSubmit = async (data) => {
      ...
      if (selectedProduct) {
         const res = await dispatch(updateProduct({ id: selectedProduct._id, data }));
      ...
      <div className="bg-white border border-slate-200 rounded-2xl p-5 md:p-6 shadow-sm">
         ...
         <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="flex flex-wrap gap-3 pt-1">
               <Button type="submit" className="bg-brand-primary hover:bg-brand-primary-dark text-white min-w-[150px]">
