...
import { fetchUsers, toggleUserRole, toggleBlockUser, deleteUser } from "@/features/auth/userSlice";
                                    ...
                                    <tr key={u._id} className="border-t border-slate-100 hover:bg-slate-50/70">
                                        ...
                                        <td className="p-3">
                                            <div className="flex flex-wrap gap-2">
                                                ...
                                                <Button variant="outline" onClick={() => dispatch(toggleUserRole(u._id))}>
                                                    {u.role === "admin" ? "Make User" : "Make Admin"}
                                                </Button>
                                                <Button variant="outline" onClick={() => dispatch(toggleBlockUser(u._id))}>
                                                    {u.blocked ? "Unblock" : "Block"}
                                                </Button>
                                                <Button variant="destructive" onClick={() => dispatch(deleteUser(u._id))}>Delete</Button>
                                            </div>
                                        </td>
                                    </tr>
                            )) : (
